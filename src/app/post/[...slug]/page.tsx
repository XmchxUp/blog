...
async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <article>
      <div className="print:rounded-none rounded-xl print:border-none border print:bg-transparent bg-card text-card-foreground print:shadow-none shadow w-full">
