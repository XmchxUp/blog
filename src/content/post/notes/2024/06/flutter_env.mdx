...
#### 项目停在 Running Gradle task 'assembleDebug'
...
可能在下载 gradle 可以查看下 `project/andriod/gradle/gradle-wrapper.properties` 文件中的
...
需要安装 Andriod SDK Build-Tools 30.0.3 版本 Languages/Android SDK/ SDK Tools 里记得勾选 Show Package Details
